...
func (v *BaseMySqlParserVisitor) VisitCreateSequence(ctx *CreateSequenceContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseMySqlParserVisitor) VisitSequenceSpec(ctx *SequenceSpecContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseMySqlParserVisitor) VisitAlterSequence(ctx *AlterSequenceContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseMySqlParserVisitor) VisitDropSequence(ctx *DropSequenceContext) interface{} {
	return v.VisitChildren(ctx)
}
