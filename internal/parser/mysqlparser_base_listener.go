// Code generated from D:/chenquan/golang/mysql-parser/internal/grammar\MySqlParser.g4 by ANTLR 4.10.1. DO NOT EDIT.
...
func (s *BaseMySqlParserListener) EnterCreateSequence(ctx *CreateSequenceContext) {}

// ExitCreateSequence is called when production createSequence is exited.
func (s *BaseMySqlParserListener) ExitCreateSequence(ctx *CreateSequenceContext) {}

// EnterSequenceSpec is called when production sequenceSpec is entered.
func (s *BaseMySqlParserListener) EnterSequenceSpec(ctx *SequenceSpecContext) {}

// ExitSequenceSpec is called when production sequenceSpec is exited.
func (s *BaseMySqlParserListener) ExitSequenceSpec(ctx *SequenceSpecContext) {}
...
func (s *BaseMySqlParserListener) EnterAlterSequence(ctx *AlterSequenceContext) {}

// ExitAlterSequence is called when production alterSequence is exited.
func (s *BaseMySqlParserListener) ExitAlterSequence(ctx *AlterSequenceContext) {}
...
func (s *BaseMySqlParserListener) EnterDropSequence(ctx *DropSequenceContext) {}

// ExitDropSequence is called when production dropSequence is exited.
func (s *BaseMySqlParserListener) ExitDropSequence(ctx *DropSequenceContext) {}
