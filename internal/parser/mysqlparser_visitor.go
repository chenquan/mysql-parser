...
type MySqlParserVisitor interface {
	...
	// Visit a parse tree produced by MySqlParser#createSequence.
	VisitCreateSequence(ctx *CreateSequenceContext) interface{}

	// Visit a parse tree produced by MySqlParser#sequenceSpec.
	...
	// Visit a parse tree produced by MySqlParser#alterSequence.
	...
	// Visit a parse tree produced by MySqlParser#dropSequence.
